...
[!\[Live Demo](https://img.shields.io/badge/🤗%20Hugging%20Face-Live%20Demo-4f8ef7?style=for-the-badge)](https://vectorxx-sentiment.hf.space)
...
│  \[polarity, pos\_score,          │
│   neg\_score, neu\_score,         │
│   tweet\_volume, pumper, ...]    │
└──────────────┬──────────────────┘
               │
               ▼
┌─────────────────────────────────┐
...
│   ├── model.py            # FinBERT loader and inference (classify\_text, classify\_batch)
│   ├── predict.py          # Random Forest prediction (predict\_stock, predict\_batch)
...
│       └── random\_forest.joblib  # Trained RF model
├── requirements.txt
└── Dockerfile
```
...
```bash
# 1. Clone the repo
git clone https://github.com/YOUR\_USERNAME/SentimentEdge.git
...
🚀 [**Try SentimentEdge on Hugging Face Spaces**](https://vectorxx-sentiment.hf.space)
