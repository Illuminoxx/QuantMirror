...
```bash
curl -X POST https://YOUR\_USERNAME-sentimentedge.hf.space/api/analyze \\
...
🚀 [**Try SentimentEdge on Hugging Face Spaces**](https://huggingface.co/spaces/YOUR_USERNAME/SentimentEdge) :vectorxx-sentiment.hf.space
